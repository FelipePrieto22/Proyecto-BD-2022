...
INSERT INTO `noticia` (`url`, `fecha_Publicación`, `contenido`, `titulo`) VALUES ('https://www.meganoticias.cl/nacional/379541-ipc-chile-mayo-2022-inflacion-en-chile-08-06-2022.html','2008-05-22','TEXTO','Inflación acumulada más alta en 28 años: IPC anota alza de 1,2%');
...
INSERT INTO `persona` (`nombre`, `profesion`, `nacionalidad`, `fecha_de_nacimiento`, `pagina_wikipedia_url`) VALUES ('hola soy german','youtuber','chilena',NULL,'https://es.wikipedia.org/wiki/Germán_Garmendia#:~:text=Germán%20Alejandro%20Garmendia%20Aranis%20(Copiapó,más%20adelante%20también%20a%20JuegaGerman.');
...
INSERT INTO `popularidad` (`fecha`, `visitas`) VALUES ('2010-05-22',300000000);
...
CREATE TABLE `tiene` (
  ...
  `nombre_medio` varchar(32) NOT NULL,
  `si_o_no` tinyint(1) DEFAULT NULL,
...
INSERT INTO `tiene` (`nombre_dueño`, `nombre_medio`, `si_o_no`, `fecha_de_adquisicion`) VALUES ('Arnold Schwarzenegger','mega',1,'2010-01-10');
...
-- Dump completed on 2022-06-08 12:17:55
